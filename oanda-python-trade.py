...
class MomentumTrader(opy.Streamer):  # 25
    ...
    def on_success(self, data):  # 36
        ...
        self.df = self.df.append(pd.DataFrame(data['tick'], index=[data['tick']['time']]))  # 38
...
if __name__=="__main__":
    ...
    mt.rates(account_id=str(config['oanda']['account_id']), instruments=['EUR_USD'], ignore_heartbeat=True)
